...
RULES = [
    (
        ...
        lambda r: (1.0 - _comp(r, "thirds_score"))
                  if _comp(r, "thirds_score") is not None and _comp(r, "thirds_score") < 0.72 else None,
    ...
    (
        ...
        lambda r: abs(_comp(r, "horizon_tilt_deg"))
                  if _comp(r, "horizon_tilt_deg") is not None and abs(_comp(r, "horizon_tilt_deg")) > 1.5 else None,
    ...
    (
        ...
        lambda r: _comp(r, "foreground_clutter")
                  if _comp(r, "foreground_clutter") is not None and _comp(r, "foreground_clutter") > 0.22 else None,
    ...
    (
        ...
        lambda r: (1.0 - min(_comp(r, "subject_isolation"), 2.0) / 2.0)
                  if _comp(r, "subject_isolation") is not None and _comp(r, "subject_isolation") < 0.85 else None,
    ...
    (
        ...
        lambda r: (0.25 - _comp(r, "negative_space"))
                  if _comp(r, "negative_space") is not None and _comp(r, "negative_space") < 0.25 else None,
    ...
    (
        ...
        lambda r: (35.0 - r["aesthetic_score"]) / 35.0
                  if r.get("aesthetic_score") is not None and r["aesthetic_score"] < 35 else None,
    ...
    (
        ...
        lambda r: 1.0
                  if _exif(r, "dof_category") == "deep" and _scene(r) == "people and portraits" else None,
    ...
    (
        ...
        lambda r: 1.0
                  if _exif(r, "light_category") == "low_light"
                  and r.get("aesthetic_score") is not None
                  and r["aesthetic_score"] < 40 else None,
    ...
    (
        ...
        lambda r: _comp(r, "highlight_clipping")
                  if _comp(r, "highlight_clipping") is not None and _comp(r, "highlight_clipping") > 0.03 else None,
    ...
    (
        ...
        lambda r: _comp(r, "shadow_clipping")
                  if _comp(r, "shadow_clipping") is not None and _comp(r, "shadow_clipping") > 0.05 else None,

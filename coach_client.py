...
RULES = [
    (
        ...
        lambda r: (
            (1.0 - _comp(r, "thirds_score")) if _comp(r, "thirds_score") is not None and _comp(r, "thirds_score") < THRESHOLDS["thirds_score_min"] else None
        ),
    ...
    (
        ...
        lambda r: (
            (1.0 - min(_comp(r, "subject_isolation"), 2.0) / 2.0)
    ...
    (
        ...
        lambda r: (
            (THRESHOLDS["negative_space_min"] - _comp(r, "negative_space"))
    ...
    (
        ...
        lambda r: (
            (THRESHOLDS["aesthetic_floor"] - r["aesthetic_score"]) / THRESHOLDS["aesthetic_floor"]
    ...
    (
        ...
        lambda r: (
            _comp(r, "shadow_clipping") if _comp(r, "shadow_clipping") is not None and _comp(r, "shadow_clipping") > THRESHOLDS["shadow_clipping"] else None
        ),
